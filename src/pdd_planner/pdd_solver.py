...
class pdd_solver:
    def __init__(self, receding, 
                       ...
                       max_edge_num=5, 
                       max_obs_num=5,
                       iter_num=2, step_time=0.1, iter_threshold=0.2, process_num=4, accelerated=True, time_print=True, pdd_en=True, **kwargs) -> None:
    ...
    def pdd_solver(self, iter):
        ...
        # if self.max_obs_num != 0:
            ...
            beta1 = 1.2
            beta2 = 1.1
            if iter == self.iter_num - 1 and self.pdd_en == True: # check convergence at the last iteration
                eta_th = 0.01
            else:
                eta_th = inf 
